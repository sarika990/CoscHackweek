      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Create an account to preserve your memories.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-800/40 border ${errors.name ? 'border-rose-500' : 'border-slate-200 dark:border-slate-800'} rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors`}
                />
              </div>
              {errors.name && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-800/40 border ${errors.confirmPassword ? 'border-rose-500' : 'border-slate-200 dark:border-slate-800'} rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition-colors`}
                />
              </div>
